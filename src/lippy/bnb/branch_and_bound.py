...
class BranchAndBound:
    ...
    space search: the set of candidate solutions is thought
    of as forming a rooted tree with the full set at the root.
    ...
    def _node_iteration(
        ...
        :param np.ndarray a_matrix: The left part of the restriction system.
        ...
        if all((
            not simplex_method.table.was_solved(),
            not simplex_method.table.has_optimal_solution()
        )):
            return
